unit Unit_FormPesquisarPedidos;
interface
uses
...
type
  TForm_PesquisarPedidos = class(TForm)
    ...
    procedure Button_NovoPedidoClick(Sender: TObject);
  private
...
implementation
{$R *.dfm}
uses Unit_DataModuleConection, Unit_FormCadastrarPedidos;
procedure TForm_PesquisarPedidos.Button_CancelarClick(Sender: TObject);
begin
    close;
end;

procedure TForm_PesquisarPedidos.Button_NovoPedidoClick(Sender: TObject);
begin
    Form_CadastrarPedidos.ShowModal;
end;
